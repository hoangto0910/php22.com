		...
		<div class="row justify-content-center">
			...
			<div class="col-12 col-lg-8">
                ...
                <ol class="foode-pager mt-50">
                    <li><a href="/mvc_new/index.php?mod=home&act=showCategory&id=8&slug=food-1588305322&page=<?php if($page == 1)
                    { echo $page = 1;}
                    else
                    { echo $page-1;} ?>"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Newer</a></li>
                    <li><a href="/mvc_new/index.php?mod=home&act=showCategory&id=8&slug=food-1588305322&page=<?php if($page == 3)
                    { echo $page = 1;}
                    else
